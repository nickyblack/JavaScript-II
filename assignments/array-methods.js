...
// Problem 1 - Use .filter() to see if first_name starts with 'S'

let firstNames = [];
console.log(runners.filter(runner => runner.first_name.startsWith('S')));

// Problem 2
// Donating 20% of procedds to charity

console.log(
    runners
         
        .map(runner => runner.donation * .20 )
        .reduce((total, donation) => total + donation, 0)
   );

// Problem 3
// organized list of names for  charity T-Shirts to print
